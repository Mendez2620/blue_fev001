...
export function FuturaHeader() {
  return <header className="futura-header"><Link className="futura-brand" to="/futura"><span>FUTURA</span><strong>Distrito Cero</strong></Link><nav aria-label="Navegación FUTURA"><Link to="/futura">Distrito</Link><Link to="/futura/my-projects">Mis proyectos</Link><Link to="/futura/my-footprint">Mi Huella</Link><Link to="/chat">Blue FEV</Link></nav></header>;
}
